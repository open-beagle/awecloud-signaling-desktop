...
const (
	...
	DesktopService_ListResourceTenants_FullMethodName   = "/awecloud.signaling.DesktopService/ListResourceTenants"
...
type DesktopServiceClient interface {
	...
	// 获取有权访问 Kubernetes 资源的 Tenant 摘要，不创建 ResourceSession
...
func (c *desktopServiceClient) ListResourceTenants(ctx context.Context, in *ListResourceTenantsRequest, opts ...grpc.CallOption) (*ListResourceTenantsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListResourceTenantsResponse)
	err := c.cc.Invoke(ctx, DesktopService_ListResourceTenants_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDesktopServiceServer) ListResourceTenants(context.Context, *ListResourceTenantsRequest) (*ListResourceTenantsResponse, error) {
...
func _DesktopService_ListResourceTenants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListResourceTenantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DesktopServiceServer).ListResourceTenants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DesktopService_ListResourceTenants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DesktopServiceServer).ListResourceTenants(ctx, req.(*ListResourceTenantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DesktopService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DesktopService_ListResourceTenants_Handler,
		},
		{
